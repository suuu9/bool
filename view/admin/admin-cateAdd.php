...
<div class="admin-content">
  <div class="admin-content-body">
    ...
    <hr>
    <form class="am-form" action="cateaddAct.php" method="POST">
          ...
          <div class="am-active" id="tab1">
              <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-8 am-u-md-4">
                  <input type="text" name="cat_name" class="am-input-sm">
                </div>
              ...
              <div class="am-g am-margin-bottom-sm">
                ...
                <div class="am-u-sm-12 am-u-md-10">
                  <textarea rows="10" name="intro" placeholder="请填写分类描述"></textarea>
                </div>
              </div>
          </div>
        </div>
