<?php include('admin-sidebar.php'); ?>
                        ...
                        <div class="am-tab-panel" id="tab2">
                            <div class="am-g am-margin-top-sm">
                                ...
                                <div class="am-u-sm-12 am-u-md-10">
                                    <textarea rows="10" id="goods_desc" name="goods_desc"></textarea>
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/javascript" src="http://localhost/bool/lib/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" src="http://localhost/bool/lib/ueditor/ueditor.all.min.js"></script>
